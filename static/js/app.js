...
.controller('PatientListController', function ($scope) {
  ...
  $scope.data = [
    ...
    {name: 'Roshan Shrestha  & Family', table: 41},
    {name: 'Binod Shrestha & Family', table: 41},
    {name: 'Shrawan Shrestha ', table: 41},
    {name: 'Purna T, Ukar', table: 41},
    ...
    {name: 'David, Tinsley Giese', table: 43},
    {name: 'Andrew Mark, Katherine', table: 43},
    {name: 'Dr. Mitch Davis, Dr. Athra Kaviani', table: 43},
    {name: 'Dr. Todd Wilson', table: 43},
    {name: 'Derek Norman', table: 43},

    {name: 'Fritz, Yvonne Norman', table: 36},
    {name: 'Jerry Tecker', table: 36},
    {name: 'Franchi & Family', table: 36},


    {name: 'Nirmal Shrestha  & Family', table: 51},
    {name: 'Reema Shrestha', table: 51},
    {name: 'Asha Amatya & Family', table: 51},
    ...
    {name: 'Saru Adhikari & Group', table: 32},
    ...
    {name: 'Sudarshan Dhital & Barsha', table: 40},
    {name: 'Tirtha & Indu ', table: 40},
    ...
    {name: 'Bishnu & Yagya ', table: 48},

    {name: 'Dr Ravikanta Parmar & Daughter', table: 53},
    {name: 'Aarik Dessaso  ', table: 53},

    {name: 'Shailesh Bhai ', table: 54},
    {name: 'Grace & Paul', table: 54},
    {name: 'Dr David Worley', table: 54},
    {name: 'Jeff & Angela Knauss', table: 54},

    {name: 'Deepak ', table: 55},
    {name: 'Tara Baral', table: 55},
    {name: 'Shesh ', table: 55},
    {name: 'Iroj Ghimire', table: 55},
    {name: 'Puru Kasaju', table: 55},

    {name: 'Amra ', table: 56},
    {name: 'Imran Bhai', table: 56},

    {name: 'Dhanen Shrestha & Friends', table: 57},
    {name: 'Rabindra Shrestha & Family', table: 57},

    {name: 'Anju Shrestha', table: 28},
    {name: 'Sangita & Family', table: 28},
    {name: 'Punam', table: 28},

    {name: 'Kumar', table: 58},
    {name: 'Billy ', table: 58},
    {name: 'Suchitra,Nisha', table: 58}
